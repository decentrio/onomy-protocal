...
[Gaia](https://github.com/onomyprotocol/onomy) application have been split into separate
repositories. This allows for both the Cosmos SDK and Gaia to evolve naturally
and independently. Thus, any future [releases](https://github.com/onomyprotocol/onomy/releases)
...
on its current versioning path (i.e. v0.36.x ) and the [Gaia](https://github.com/onomyprotocol/onomy)
application will become v2.0.x.

__[Gaia](https://github.com/onomyprotocol/onomy) application v2.0.3 is
...
v2.0.3 of [Gaia](https://github.com/onomyprotocol/onomy).

   __NOTE__: Go [1.13+](https://golang.org/dl/) is required!

   ```bash
   git clone https://github.com/onomyprotocol/onomy.git && cd gaia && git checkout v2.0.3; make install
   ```
...
4. We highly recommend standing up a [testnet](https://github.com/onomyprotocol/onomy/blob/master/docs/deploy-testnet.md)
